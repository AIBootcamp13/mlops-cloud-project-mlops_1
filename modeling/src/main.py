...
def run_inference(data_root_path, model_root_path, batch_size=64):
    ...
    temperature_results = run_inference_temperature(data_root_path, model_root_path, batch_size=64)
    PM_results = run_inference_PM(data_root_path, model_root_path, batch_size=64)
